...
%  coefficients
v1 = VideoWriter('LHS_Sobol_Indices.mp4','MPEG-4');
v2 = VideoWriter('LHS_scattertheta_1.mp4','MPEG-4');
v3 = VideoWriter('LHS_scattertheta_2.mp4','MPEG-4');;
...
A(:,1) = param1(1) + (param1(2) - param1(1)).*lhsp(:,1);
A(:,2) = param2(1) + (param2(2) - param2(1)).*lhsp(:,2);

B(:,1) = param1(1) + (param1(2) - param1(1)).*lhsp(:,3);
B(:,2) = param2(1) + (param2(2) - param2(1)).*lhsp(:,4);
...
xlabel('L [cm]'), ylabel('Sobol Indice'), title('LHS Sobol Indices vs. Length')
